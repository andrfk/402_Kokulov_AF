...
class StudentsListTest extends TestCase
{
    ...
    public function testGet()
    {
        $student = new Student();
        $studentsList = new StudentsList();
        $student -> setName("Андрей") -> setLastName("Кокулов") -> setFaculty("ФМиИТ") -> setCourse(4) -> setGroup(402);
        $studentsList -> add($student);
    ...
    public function testCurrentAndKey()
    {
        ...
        $studentsList = new StudentsList();
        $student1 -> setName("Андрей") -> setLastName("Кокулов") -> setFaculty("ФМиИТ")-> setCourse(4) -> setGroup(402);
        $student2 -> setName("Карл") -> setLastName("Пушкин") -> setFaculty("ФЭТ") -> setCourse(2) -> setGroup(201);
        $student3 -> setName("Иван") -> setLastName("Докин") -> setFaculty("ФизХим") -> setCourse(3) -> setGroup(303);
